...
class Reits(models.Model):
    asset = models.ForeignKey(Asset, on_delete=models.CASCADE, related_name='reits', null=False)
    portfolio = models.ForeignKey(Portfolio, on_delete=models.CASCADE, related_name='reits', null=False)
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='reits', null=False)
    ...
    def update_quantity_amount_prices(self):
        ...
        reits.update(average_purchase_price_mv=average_purchase_price_mv)
        ...
        reits.update(average_purchase_price_fifo=average_purchase_price_fifo)
    ...
    def update_rate_of_returns(self):
        ...
        reits.update(rate_of_return_mv=rate_of_return_mv)
        ...
        reits.update(rate_of_return_fifo=rate_of_return_fifo)
...
class ReitsTransaction(models.Model):
    from django import utils

    reits = models.ForeignKey(Reits, on_delete=models.CASCADE, related_name='transaction', null=False)
