...
from guardianapp.views import GuardianCreateView, GuardianDetailView, GuardianDeleteView, GuardianTransactionCreateView, \
    GuardianTransactionDeleteView, guardian_transaction_delete_all
...
urlpatterns = [
    ...
    path('guardian_transaction_delete_all/', guardian_transaction_delete_all, name='guardian_transaction_delete_all'),
